...
//use Chisimba\RedirectableUrlMatcher;
//use Chisimba\ControllerResolver;
 
class Framework implements HttpKernelInterface, EventSubscriberInterface
{
    ...
    {
        $this['dispatcher']->addListener(ChisimbaEvents::BEFORE, function (GetResponseEvent $event) use ($callback) {
    ...
    {
        $this['dispatcher']->addListener(ChisimbaEvents::AFTER, function (FilterResponseEvent $event) use ($callback) {
    ...
    {
        $this['dispatcher']->addListener(ChisimbaEvents::ERROR, function (GetResponseForErrorEvent $event) use ($callback) {
    ...
    public function onKernelRequest(KernelEvent $event)
    {
        if (HttpKernelInterface::MASTER_REQUEST === $event->getRequestType()) {
            ...
            $this['dispatcher']->dispatch(ChisimbaEvents::BEFORE, $event);
        }
    }
    ...
    {
        if (HttpKernelInterface::MASTER_REQUEST === $event->getRequestType()) {
            $this['dispatcher']->dispatch(ChisimbaEvents::AFTER, $event);
        }
    }
    ...
    public function onKernelException(GetResponseForExceptionEvent $event)
    {
        ...
        $this['dispatcher']->dispatch(ChisimbaEvents::ERROR, $errorEvent);
