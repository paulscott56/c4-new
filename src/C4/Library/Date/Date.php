...
namespace C4\Library\Date;

use C4\Library\Cache\Storage\Adapter\AdapterInterface as CacheAdapter;
use C4\Library\Locale\Data\Cldr;
use C4\Library\Locale\Format;
use C4\Library\Locale\Locale;
use C4\Library\Locale\Math;
use C4\Library\TimeSync;
...
class Date extends DateObject
{
     ...
     *
     * @param  string|integer|\C4\Library\Date\Date|array  $date    OPTIONAL Date value or value of date part to set
     *                                                 ,depending on $part. If null the actual time is set
     * @param  string                          $part    OPTIONAL Defines the input format of $date
     * @param  string|\C4\Library\Locale\Locale              $locale  OPTIONAL Locale for parsing input
     * @return \C4\Library\Date\Date
     * @throws \C4\Library\Date\Exception
     */
                    ...
                    case 'cache' :
                        if ($value === null) {
                            ...
                            if (!$value instanceof CacheAdapter) {
                                throw new Exception\InvalidArgumentException("Instance of C4\Library\Cache\Storage\Adapter\AdapterInterface expected");
                            }
                    ...
                    case 'timesync' :
                        if ($value === null) {
                            ...
                            if (!$value instanceof TimeSync\Protocol) {
                                throw new Exception\InvalidArgumentException("Instance of C4\Library_TimeSync expected for option timesync");
                            }
    ...
    /**
     * Returns this object's internal UNIX timestamp (equivalent to C4\Library_Date::TIMESTAMP).
     ...
     * @param  string|integer|array|\C4\Library\Date\Date  $stamp   Timestamp to calculate, when null the actual timestamp is calculated
     * @return \C4\Library\Date\Date|integer
     * @throws \C4\Library\Date\Exception
     */
     ...
     *
     * @param  integer|string|array|\C4\Library\Date\Date  $timestamp  Timestamp to set
     * @return \C4\Library\Date\Date Provides fluid interface
     * @throws \C4\Library\Date\Exception
     */
     ...
     * Adds a timestamp
     *
     * @param  integer|string|array|\C4\Library\Date\Date  $timestamp  Timestamp to add
     * @return \C4\Library\Date\Date Provides fluid interface
     * @throws \C4\Library\Date\Exception
     */
     ...
     *
     * @param  integer|string|array|\C4\Library\Date\Date  $timestamp  Timestamp to sub
     * @return \C4\Library\Date\Date Provides fluid interface
     * @throws \C4\Library\Date\Exception
     */
     ...
     *
     * @param  integer|string|array|\C4\Library\Date\Date  $timestamp  Timestamp to compare
     ...
     *
     * @param  string|integer|\C4\Library\Date\Date  $part  OPTIONAL Defines the date or datepart to return as integer
     ...
     * For a complete list of supported datepart values look into the docu
     *
     * @param  string|integer|array|\C4\Library\Date\Date  $date    Date or datepart to set
     ...
     * For a complete list of supported datepart values look into the docu.
     *
     * @param  string|integer|array|\C4\Library\Date\Date  $date    Date or datepart to add
     ...
     *
     * @param  string|integer|array|\C4\Library\Date\Date  $date    Date or datepart to subtract
     ...
     *
     * @param  string|integer|array|\C4\Library\Date\Date  $date    Date or datepart to compare with the date object
    ...
    /**
     * Returns a new instance of C4\Library_Date with the selected part copied.
     ...
     * @param  string|\C4\Library\Locale\Locale  $locale  OPTIONAL New object's locale.  No adjustments to timezone are made.
     * @return \C4\Library\Date\Date New clone with requested part
     */
     ...
     * @return integer|string|\C4\Library\Date\Date  new timestamp or \C4\Library\Date\Date depending on calculation
     */
     ...
     * @param  string|integer|array|\C4\Library\Date\Date  $date    Date or datepart to calculate with
     * @param  string                          $part    Part of the date to calculate, if null the timestamp is used
     * @param  string|\C4\Library\Locale\Locale              $locale  Locale for parsing input
     * @return integer|string|\C4\Library\Date\Date        new timestamp
     * @throws \C4\Library\Date\Exception
     */
    private function _calculate($calc, $date, $part, $locale)
    {
        ...
        switch($part) {
            ...
            case self::DATES:
                ...
                } catch (\C4\Library\Locale\Exception\ExceptionInterface $e) {
     ...
     *
     * @param  string|integer|array|\C4\Library\Date\Date  $date    Date or datepart to equal with
     ...
     *
     * @param  string|integer|array|\C4\Library\Date\Date  $date    Date or datepart to compare with
     * @param  string                          $part    OPTIONAL Part of the date to compare, if null the timestamp is used
     * @param  string|\C4\Library\Locale\Locale              $locale  OPTIONAL Locale for parsing input
     * @return boolean
     * @throws \C4\Library\Date\Exception
    ...
    /**
     * Returns only the time of the date as new C4\Library_Date object
     * For example:
     ...
     *
     * @param  string                    $calc    Calculation to make
     * @param  string|integer|array|\C4\Library\Date\Date  $time    Time to calculate with, if null the actual time is taken
     * @param  string                          $format  Timeformat for parsing input
     * @param  string|\C4\Library\Locale\Locale              $locale  Locale for parsing input
     * @return integer|\C4\Library\Date\Date  new time
     * @throws \C4\Library\Date\Exception
     */
     ...
     *
     * @param  string|integer|array|\C4\Library\Date\Date  $time    Time to set
     ...
     *
     * @param  string|integer|array|\C4\Library\Date\Date  $time    Time to add
     * @param  string                          $format  OPTIONAL Timeformat for parsing input
     * @param  string|\C4\Library\Locale\Locale              $locale  OPTIONAL Locale for parsing input
     * @return \C4\Library\Date\Date Provides fluid interface
     * @throws \C4\Library\Date\Exception
     ...
     * For example: HH:mm:ss -> 10 -> -10 hours
     *
     * @param  string|integer|array|\C4\Library\Date\Date  $time    Time to sub
     * @param  string                          $format  OPTIONAL Timeformat for parsing input
     * @param  string|\C4\Library\Locale\Locale              $locale  OPTIONAL Locale for parsing input
     * @return \C4\Library\Date\Date Provides fluid inteface
     * @throws \C4\Library\Date\Exception
     */
     ...
     * For example: HH:mm:ss -> 10 -> 10 hours
     *
     * @param  string|integer|array|\C4\Library\Date\Date  $time    Time to compare
     * @param  string                          $format  OPTIONAL Timeformat for parsing input
     * @param  string|\C4\Library\Locale\Locale              $locale  OPTIONAL Locale for parsing input
     * @return integer  0 = equal, 1 = later, -1 = earlier
     * @throws \C4\Library\Date\Exception
     ...
     *
     * @param  string                          $calc    Calculation to make
     * @param  string|integer|array|\C4\Library\Date\Date  $date    Date to calculate with, if null the actual date is taken
     * @param  string                          $format  Date format for parsing
     * @param  string|\C4\Library\Locale\Locale              $locale  Locale for parsing input
     * @return integer|\C4\Library\Date\Date  new date
     * @throws \C4\Library\Date\Exception
     */
     ...
     *
     * @param  string|integer|array|\C4\Library\Date\Date  $date    Date to set
     ...
     *
     * @param  string|integer|array|\C4\Library\Date\Date  $date    Date to add
     ...
     *
     * @param  string|integer|array|\C4\Library\Date\Date  $date    Date to sub
     * @param  string                          $format  OPTIONAL Date format for parsing input
     * @param  string|\C4\Library\Locale\Locale              $locale  OPTIONAL Locale for parsing input
     * @return \C4\Library\Date\Date Provides fluid interface
     * @throws \C4\Library\Date\Exception
     ...
     *
     * @param  string|integer|array|\C4\Library\Date\Date  $date    Date to compare
     * @param  string                          $format  OPTIONAL Date format for parsing input
     * @param  string|\C4\Library\Locale\Locale              $locale  OPTIONAL Locale for parsing input
     * @return integer  0 = equal, 1 = later, -1 = earlier
     * @throws \C4\Library\Date\Exception
     ...
     *
     * @param  string|integer|\C4\Library\Date\Date  $date    ISO Date to set
     * @param  string|\C4\Library\Locale\Locale        $locale  OPTIONAL Locale for parsing input
     * @return \C4\Library\Date\Date Provides fluid interface
     * @throws \C4\Library\Date\Exception
     */
     ...
     * Returned is the new date object
     *
     * @param  string|integer|\C4\Library\Date\Date  $date    ISO Date to add
     * @param  string|\C4\Library\Locale\Locale        $locale  OPTIONAL Locale for parsing input
     * @return \C4\Library\Date\Date Provides fluid interface
     * @throws \C4\Library\Date\Exception
     */
     ...
     * Returned is the new date object
     *
     * @param  string|integer|\C4\Library\Date\Date  $date    ISO Date to sub
     * @param  string|\C4\Library\Locale\Locale        $locale  OPTIONAL Locale for parsing input
     * @return \C4\Library\Date\Date Provides fluid interface
     * @throws \C4\Library\Date\Exception
     */
     ...
     * Returned is the new date object
     *
     * @param  string|integer|\C4\Library\Date\Date  $date    RFC 822 to set
     * @param  string|\C4\Library\Locale\Locale        $locale  OPTIONAL Locale for parsing input
     * @return \C4\Library\Date\Date Provides fluid interface
     * @throws \C4\Library\Date\Exception
     */
     ...
     * Returned is the new date object
     *
     * @param  string|integer|\C4\Library\Date\Date  $date    RFC 822 Date to add
     * @param  string|\C4\Library\Locale\Locale        $locale  OPTIONAL Locale for parsing input
     * @return \C4\Library\Date\Date Provides fluid interface
     * @throws \C4\Library\Date\Exception
     */
     ...
     * Returned is the new date object
     *
     * @param  string|integer|\C4\Library\Date\Date  $date    RFC 822 Date to sub
     * @param  string|\C4\Library\Locale\Locale        $locale  OPTIONAL Locale for parsing input
     * @return \C4\Library\Date\Date Provides fluid interface
     * @throws \C4\Library\Date\Exception
     */
     ...
     * For a list of cities and correct locations use the class C4\Library_Date_Cities
     *
     ...
     *
     * @param  integer|array|\C4\Library\Date\Date  $year  Year to check
     * @return boolean
     */
     ...
     *
     * @param  string                          $calc    Calculation to make
     * @param  string|integer|array|\C4\Library\Date\Date  $date    Date or Part to calculate
     ...
     *
     * @param  string                    $calc    Calculation to make
     * @param  string|integer|\C4\Library\Date\Date  $value   Datevalue to calculate with, if null the actual value is taken
     * @param  string|\C4\Library\Locale\Locale        $locale  Locale for parsing input
     * @return integer|\C4\Library\Date\Date  new date
     * @throws \C4\Library\Date\Exception
     */
     ...
     * Returned is the new date object
     *
     * @param  string|integer|array|\C4\Library\Date\Date  $date    Year to set
     * @param  string|\C4\Library\Locale\Locale              $locale  OPTIONAL Locale for parsing input
     * @return \C4\Library\Date\Date Provides fluid interface
     * @throws \C4\Library\Date\Exception
     */
     ...
     * Returned is the new date object
     *
     * @param  string|integer|array|\C4\Library\Date\Date  $date    Year to add
     * @param  string|\C4\Library\Locale\Locale              $locale  OPTIONAL Locale for parsing input
     * @return \C4\Library\Date\Date Provides fluid interface
     * @throws \C4\Library\Date\Exception
     */
     ...
     * Returned is the new date object
     *
     * @param  string|integer|array|\C4\Library\Date\Date  $date    Year to sub
     * @param  string|\C4\Library\Locale\Locale              $locale  OPTIONAL Locale for parsing input
     * @return \C4\Library\Date\Date Provides fluid interface
     * @throws \C4\Library\Date\Exception
     */
     ...
     * Returns if equal, earlier or later
     *
     * @param  string|integer|array|\C4\Library\Date\Date  $year    Year to compare
     * @param  string|\C4\Library\Locale\Locale              $locale  OPTIONAL Locale for parsing input
     * @return integer  0 = equal, 1 = later, -1 = earlier
     * @throws \C4\Library\Date\Exception
     */
     ...
     *
     * @param  string                          $calc    Calculation to make
     * @param  string|integer|array|\C4\Library\Date\Date  $month   Month to calculate with, if null the actual month is taken
     * @param  string|\C4\Library\Locale\Locale              $locale  Locale for parsing input
     * @return integer|\C4\Library\Date\Date  new time
     * @throws \C4\Library\Date\Exception
     */
     ...
     * Returned is the new date object
     *
     * @param  string|integer|array|\C4\Library\Date\Date  $month   Month to set
     * @param  string|\C4\Library\Locale\Locale              $locale  OPTIONAL Locale for parsing input
     * @return \C4\Library\Date\Date Provides fluid interface
     * @throws \C4\Library\Date\Exception
     */
     ...
     * Returned is the new date object
     *
     * @param  string|integer|array|\C4\Library\Date\Date  $month   Month to add
     * @param  string|\C4\Library\Locale\Locale              $locale  OPTIONAL Locale for parsing input
     * @return \C4\Library\Date\Date Provides fluid interface
     * @throws \C4\Library\Date\Exception
     */
     ...
     * Returned is the new date object
     *
     * @param  string|integer|array|\C4\Library\Date\Date  $month   Month to sub
     * @param  string|\C4\Library\Locale\Locale              $locale  OPTIONAL Locale for parsing input
     * @return \C4\Library\Date\Date Provides fluid interface
     * @throws \C4\Library\Date\Exception
     */
     ...
     * Returns if equal, earlier or later
     *
     * @param  string|integer|array|\C4\Library\Date\Date  $month   Month to compare
     * @param  string|\C4\Library\Locale\Locale              $locale  OPTIONAL Locale for parsing input
     * @return integer  0 = equal, 1 = later, -1 = earlier
     * @throws \C4\Library\Date\Exception
     */
     ...
     *
     * @param string $calc                           Type of calculation to make
     * @param string|integer|\C4\Library\Date\Date $day    Day to calculate, when null the actual day is calculated
     * @param string|\C4\Library\Locale\Locale     $locale Locale for parsing input
     * @return \C4\Library\Date\Date|integer
     */
     ...
     *
     * @param  string|integer|array|\C4\Library\Date\Date  $month   Day to set
     * @param  string|\C4\Library\Locale\Locale              $locale  OPTIONAL Locale for parsing input
     * @return \C4\Library\Date\Date Provides fluid interface
     * @throws \C4\Library\Date\Exception
     */
     ...
     * set locale.
     *
     * @param  string|integer|array|\C4\Library\Date\Date  $month   Day to add
     * @param  string|\C4\Library\Locale\Locale              $locale  OPTIONAL Locale for parsing input
     * @return \C4\Library\Date\Date Provides fluid interface
     * @throws \C4\Library\Date\Exception
     */
     ...
     * set locale.
     *
     * @param  string|integer|array|\C4\Library\Date\Date  $month   Day to sub
     * @param  string|\C4\Library\Locale\Locale              $locale  OPTIONAL Locale for parsing input
     * @return \C4\Library\Date\Date Provides fluid interface
     * @throws \C4\Library\Date\Exception
     */
     ...
     * Returns if equal, earlier or later
     *
     * @param  string|integer|array|\C4\Library\Date\Date  $day     Day to compare
     * @param  string|\C4\Library\Locale\Locale              $locale  OPTIONAL Locale for parsing input
     * @return integer  0 = equal, 1 = later, -1 = earlier
     * @throws \C4\Library\Date\Exception
     */
     ...
     *
     * @param  string                               $calc    Type of calculation to make
     * @param  string|integer|array|\C4\Library\Date\Date $weekday Weekday to calculate, when null the actual weekday is calculated
     * @param  string|\C4\Library\Locale\Locale           $locale  Locale for parsing input
     * @return \C4\Library\Date\Date|integer
     * @throws \C4\Library\Date\Exception
     */
     ...
     *
     * @param  string|integer|array|\C4\Library\Date\Date  $month   Weekday to set
     * @param  string|\C4\Library\Locale\Locale              $locale  OPTIONAL Locale for parsing input
     * @return \C4\Library\Date\Date Provides fluid interface
     * @throws \C4\Library\Date\Exception
     */
     ...
     * wednesday.
     *
     * @param  string|integer|array|\C4\Library\Date\Date  $month   Weekday to add
     * @param  string|\C4\Library\Locale\Locale              $locale  OPTIONAL Locale for parsing input
     * @return \C4\Library\Date\Date Provides fluid interface
     * @throws \C4\Library\Date\Exception
     */
     ...
     * wednesday.
     *
     * @param  string|integer|array|\C4\Library\Date\Date  $month   Weekday to sub
     * @param  string|\C4\Library\Locale\Locale              $locale  OPTIONAL Locale for parsing input
     * @return \C4\Library\Date\Date Provides fluid interface
     * @throws \C4\Library\Date\Exception
     */
     ...
     * Returns if equal, earlier or later
     *
     * @param  string|integer|array|\C4\Library\Date\Date  $weekday  Weekday to compare
     * @param  string|\C4\Library\Locale\Locale              $locale   OPTIONAL Locale for parsing input
     * @return integer  0 = equal, 1 = later, -1 = earlier
     * @throws \C4\Library\Date\Exception
     */
     ...
     *
     * @param  string|integer|array|\C4\Library\Date\Date  $day     Day of Year to set
     * @param  string|\C4\Library\Locale\Locale              $locale  OPTIONAL Locale for parsing input
     * @return \C4\Library\Date\Date Provides fluid interface
     * @throws \C4\Library\Date\Exception
     */
     ...
     *
     * @param  string|integer|array|\C4\Library\Date\Date  $day     Day of Year to add
     * @param  string|\C4\Library\Locale\Locale              $locale  OPTIONAL Locale for parsing input
     * @return \C4\Library\Date\Date Provides fluid interface
     * @throws \C4\Library\Date\Exception
     */
     ...
     *
     * @param  string|integer|array|\C4\Library\Date\Date  $day     Day of Year to sub
     * @param  string|\C4\Library\Locale\Locale              $locale  OPTIONAL Locale for parsing input
     * @return \C4\Library\Date\Date Provides fluid interface
     * @throws \C4\Library\Date\Exception
     */
     ...
     * Returns if equal, earlier or later
     *
     * @param  string|integer|array|\C4\Library\Date\Date  $day     Day of Year to compare
     * @param  string|\C4\Library\Locale\Locale              $locale  OPTIONAL Locale for parsing input
     * @return integer  0 = equal, 1 = later, -1 = earlier
     * @throws \C4\Library\Date\Exception
     */
     ...
     *
     * @param  string|integer|array|\C4\Library\Date\Date  $hour    Hour to set
     * @param  string|\C4\Library\Locale\Locale              $locale  OPTIONAL Locale for parsing input
     * @return \C4\Library\Date\Date Provides fluid interface
     * @throws \C4\Library\Date\Exception
     */
     ...
     *
     * @param  string|integer|array|\C4\Library\Date\Date  $hour    Hour to add
     * @param  string|\C4\Library\Locale\Locale              $locale  OPTIONAL Locale for parsing input
     * @return \C4\Library\Date\Date Provides fluid interface
     * @throws \C4\Library\Date\Exception
     */
     ...
     *
     * @param  string|integer|array|\C4\Library\Date\Date  $hour    Hour to sub
     * @param  string|\C4\Library\Locale\Locale              $locale  OPTIONAL Locale for parsing input
     * @return \C4\Library\Date\Date Provides fluid interface
     * @throws \C4\Library\Date\Exception
     */
     ...
     * Returns if equal, earlier or later
     *
     * @param  string|integer|array|\C4\Library\Date\Date  $hour    Hour to compare
     * @param  string|\C4\Library\Locale\Locale              $locale  OPTIONAL Locale for parsing input
     * @return integer  0 = equal, 1 = later, -1 = earlier
     * @throws \C4\Library\Date\Exception
     */
     ...
     *
     * @param  string|integer|array|\C4\Library\Date\Date  $minute  Minute to set
     * @param  string|\C4\Library\Locale\Locale              $locale  OPTIONAL Locale for parsing input
     * @return \C4\Library\Date\Date Provides fluid interface
     * @throws \C4\Library\Date\Exception
     */
     ...
     *
     * @param  string|integer|array|\C4\Library\Date\Date  $minute  Minute to add
     * @param  string|\C4\Library\Locale\Locale              $locale  OPTIONAL Locale for parsing input
     * @return \C4\Library\Date\Date Provides fluid interface
     * @throws \C4\Library\Date\Exception
     */
     ...
     *
     * @param  string|integer|array|\C4\Library\Date\Date  $minute  Minute to sub
     * @param  string|\C4\Library\Locale\Locale              $locale  OPTIONAL Locale for parsing input
     * @return \C4\Library\Date\Date Provides fluid interface
     * @throws \C4\Library\Date\Exception
     */
     ...
     * Returns if equal, earlier or later
     *
     * @param  string|integer|array|\C4\Library\Date\Date  $minute  Hour to compare
     * @param  string|\C4\Library\Locale\Locale              $locale  OPTIONAL Locale for parsing input
     * @return integer  0 = equal, 1 = later, -1 = earlier
     * @throws \C4\Library\Date\Exception
     */
     ...
     *
     * @param  string|integer|array|\C4\Library\Date\Date $second Second to set
     * @param  string|\C4\Library\Locale\Locale             $locale (Optional) Locale for parsing input
     * @return \C4\Library\Date\Date Provides fluid interface
     * @throws \C4\Library\Date\Exception
     */
     ...
     *
     * @param  string|integer|array|\C4\Library\Date\Date $second Second to add
     * @param  string|\C4\Library\Locale\Locale             $locale (Optional) Locale for parsing input
     * @return \C4\Library\Date\Date Provides fluid interface
     * @throws \C4\Library\Date\Exception
     */
     ...
     *
     * @param  string|integer|array|\C4\Library\Date\Date $second Second to sub
     * @param  string|\C4\Library\Locale\Locale             $locale (Optional) Locale for parsing input
     * @return \C4\Library\Date\Date Provides fluid interface
     * @throws \C4\Library\Date\Exception
     */
     ...
     * Returns if equal, earlier or later
     *
     * @param  string|integer|array|\C4\Library\Date\Date $second Second to compare
     * @param  string|\C4\Library\Locale\Locale             $locale (Optional) Locale for parsing input
     * @return integer  0 = equal, 1 = later, -1 = earlier
     * @throws \C4\Library\Date\Exception
     */
     ...
     *
     * @param  integer|\C4\Library\Date\Date $milli     (Optional) Millisecond to set, when null the actual millisecond is set
     ...
     *
     * @param  integer|\C4\Library\Date\Date $milli     (Optional) Millisecond to add, when null the actual millisecond is added
     ...
     *
     * @param  integer|\C4\Library\Date\Date $milli     (Optional) Millisecond to sub, when null the actual millisecond is subtracted
     * @param  integer           $precision (Optional) Fractional precision for the given milliseconds
     * @return \C4\Library\Date\Date Provides fluid interface
     */
     ...
     *
     * @param  integer|\C4\Library\Date\Date  $milli  OPTIONAL Millisecond to compare, when null the actual millisecond is compared
     * @param  integer            $precision  OPTIONAL Fractional precision for the given milliseconds
     * @throws \C4\Library\Date\Exception On invalid input
     * @return integer  0 = equal, 1 = later, -1 = earlier
     */
     ...
     *
     * @param  string|integer|array|\C4\Library\Date\Date  $week    Week to set
     * @param  string|\C4\Library\Locale\Locale              $locale  OPTIONAL Locale for parsing input
     * @return \C4\Library\Date\Date Provides fluid interface
     * @throws \C4\Library\Date\Exception
     */
     ...
     *
     * @param  string|integer|array|\C4\Library\Date\Date  $week    Week to add
     * @param  string|\C4\Library\Locale\Locale              $locale  OPTIONAL Locale for parsing input
     * @return \C4\Library\Date\Date Provides fluid interface
     * @throws \C4\Library\Date\Exception
     */
     ...
     *
     * @param  string|integer|array|\C4\Library\Date\Date  $week    Week to sub
     * @param  string|\C4\Library\Locale\Locale              $locale  OPTIONAL Locale for parsing input
     * @return \C4\Library\Date\Date Provides fluid interface
     * @throws \C4\Library\Date\Exception
     */
     ...
     *
     * @param  string|integer|array|\C4\Library\Date\Date  $week    Week to compare
     * @param  string|\C4\Library\Locale\Locale              $locale  OPTIONAL Locale for parsing input
     * @return integer 0 = equal, 1 = later, -1 = earlier
     */
     ...
     *
     * @param  string|\C4\Library\Locale\Locale $locale (Optional) Locale for parsing input
     * @throws \C4\Library\Date\Exception When the given locale does not exist
     * @return \C4\Library\Date\Date Provides fluent interface
     */
     ...
     *
     * @param  string|array|\C4\Library\Date\Date $date   Date to parse for correctness
     * @param  string                 $format (Optional) Format for parsing the date string
     * @param  string|\C4\Library\Locale\Locale     $locale (Optional) Locale for parsing date parts
