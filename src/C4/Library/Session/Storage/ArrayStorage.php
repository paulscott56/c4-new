...
class ArrayStorage extends ArrayObject implements StorageInterface
{
    ...
    public function setMetadata($key, $value, $overwriteArray = false)
    {
        ...
        if (isset($this['__C4'][$key]) && is_array($value)) {
            if ($overwriteArray) {
                $this['__C4'][$key] = $value;
            } elseif (null === $value) {
                $array = $this['__C4'];
                ...
                $this['__C4'][$key] = array_replace_recursive($this['__C4'][$key], $value);
            }
        } else {
            if ((null === $value) && isset($this['__C4'][$key])) {
                $array = $this['__C4'];
                unset($array[$key]);
                $this['__C4'] = $array;
                unset($array);
    ...
    public function getMetadata($key = null)
    {
        ...
        if (!array_key_exists($key, $this['__C4'])) {
            return false;
        }

        return $this['__C4'][$key];
    }
