<?php 
namespace C4\Tests\Library\Session;

use C4\Library\Session\Configuration\SessionConfiguration;
...
class SessionConfigurationTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->setExpectedException('C4\Library\Session\Exception\InvalidArgumentException', 'Invalid save_path provided');
    ...
    {
        $this->setExpectedException('C4\Library\Session\Exception\InvalidArgumentException', 'Invalid save handler specified');
    ...
    {
        $this->setExpectedException('C4\Library\Session\Exception\InvalidArgumentException', 'Invalid gc_probability; must be numeric');
        $this->config->setGcProbability('foobar_bogus');
    }
    
    public function testSettingInvalidGcProbabilityRaisesException2()
    {
        $this->setExpectedException('C4\Library\Session\Exception\InvalidArgumentException', 'Invalid gc_probability; must be a percentage');
    ...
    {
        $this->setExpectedException('C4\Library\Session\Exception\InvalidArgumentException', 'Invalid gc_divisor; must be numeric');
        $this->config->setGcDivisor('foobar_bogus');
    }
    
    public function testSettingInvalidGcDivisorRaisesException2()
    {
        $this->setExpectedException('C4\Library\Session\Exception\InvalidArgumentException', 'Invalid gc_divisor; must be a positive integer');
    ...
    {
        $this->setExpectedException('C4\Library\Session\Exception\InvalidArgumentException', 'Invalid gc_maxlifetime; must be numeric');
        $this->config->setGcMaxlifetime('foobar_bogus');
    }
    
    public function testSettingInvalidGcMaxlifetimeRaisesException2()
    {
        $this->setExpectedException('C4\Library\Session\Exception\InvalidArgumentException', 'Invalid gc_maxlifetime; must be a positive integer');
    ...
    {
        $this->setExpectedException('C4\Library\Session\Exception\InvalidArgumentException', 'Invalid serialize handler specified');
    ...
    {
        $this->setExpectedException('C4\Library\Session\Exception\InvalidArgumentException', 'Invalid cookie_lifetime; must be numeric');
        $this->config->setCookieLifetime('foobar_bogus');
    }
    
    public function testSettingInvalidCookieLifetimeRaisesException2()
    {    
        $this->setExpectedException('C4\Library\Session\Exception\InvalidArgumentException', 'Invalid cookie_lifetime; must be a positive integer or zero');
    ...
    {
        $this->setExpectedException('C4\Library\Session\Exception\InvalidArgumentException', 'Invalid cookie path');
    ...
    {
        $this->setExpectedException('C4\Library\Session\Exception\InvalidArgumentException', 'Invalid cookie domain: must be a string');
        $this->config->setCookieDomain(24);
    }
    
    // Needs the validator code for HostnameValidator
    //public function testSettingInvalidCookieDomainRaisesException2()
    //{
    //    $this->setExpectedException('C4\Library\Session\Exception\InvalidArgumentException', 'Invalid cookie domain: must be a string');
    //    var_dump($this->config->setCookieDomain(1.05));
    //}
    ...
    {
        $this->setExpectedException('C4\Library\Session\Exception\InvalidArgumentException', 'Invalid entropy_file provided');
    ...
    {
        $this->setExpectedException('C4\Library\Session\Exception\InvalidArgumentException', 'Invalid entropy_length; must be numeric');
        $this->config->setEntropyLength('foobar_bogus');
    }
    
    public function testSettingInvalidEntropyLengthRaisesException2()
    {
        $this->setExpectedException('C4\Library\Session\Exception\InvalidArgumentException', 'Invalid entropy_length; must be a positive integer or zero');
    ...
    {
        $this->setExpectedException('C4\Library\Session\Exception\InvalidArgumentException', 'Invalid cache limiter provided');
    ...
    {
        $this->setExpectedException('C4\Library\Session\Exception\InvalidArgumentException', 'Invalid cache_expire; must be numeric');
        $this->config->setCacheExpire('foobar_bogus');
    }

    public function testSettingInvalidCacheExpireRaisesException2()
    {
        $this->setExpectedException('C4\Library\Session\Exception\InvalidArgumentException', 'Invalid cache_expire; must be a positive integer');
    ...
    {
        $this->setExpectedException('C4\Library\Session\Exception\InvalidArgumentException', 'Invalid hash function provided');
    ...
    {
        $this->setExpectedException('C4\Library\Session\Exception\InvalidArgumentException', 'Invalid hash bits per character provided');
