...
namespace C4\Tests\Library\Authentication\Adapter;

use C4\Library\Authentication\Adapter;
use C4\Library\Authentication;
...
class DigestTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testOptionRequiredException()
    {
        ...
        try {
            ...
            $this->fail('Expected C4\Library_Auth_Adapter_Exception not thrown upon authentication attempt before setting '
                      . 'a required option');
    ...
    public function testFileNonExistentException()
    {
        ...
        try {
            $adapter->authenticate();
            $this->fail('Expected C4\Library_Auth_Adapter_Exception not thrown upon authenticating against nonexistent '
                      . 'file');
        } catch (Adapter\Exception\ExceptionInterface $e) {
